...
describe("Create select query", ()=>{
    ...
    test("Should return a select of person", async()=>{
        ...
        let rowCount = (await context.ExecuteQuery(select)).length;
     ...
     test("Should update a person", async()=>{
        ...
        let rowCount = (await context.ExecuteQuery(select)).affectedRows;
     ...
     test("Should increment age of an person", async()=>{
        ...
        let rowCount = (await context.ExecuteQuery(update)).affectedRows;
